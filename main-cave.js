...
function init() {
  ...
  light = new THREE.PointLight(0xc4c4cc4, 5);
  light.position.set(10, 6, 20);
  scene.add(light);
  var ambient = new THREE.AmbientLight(0xffb5be, 0.4)
  ambient.position.set(100, 60, -200);
  scene.add(ambient)
...
function objectLoader(){
  ...
  scene.add( mesh );
   ...
   //img.onload = function () {
      ...
      let text1 = new THREE.TextureLoader().load('textures/island1.png');
