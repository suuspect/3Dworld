...
light = new THREE.PointLight(0x6600ff, 3);
light.position.set(10, 30, 200);
light = new THREE.PointLight(0x6600ff, 4);
light.position.set(300, -100, 400);
scene.add(light);
var ambient = new THREE.AmbientLight(0xebdeff, 1)
scene.add(ambient)
...
let materialArray = [];
let texture_ft = new THREE.TextureLoader().load('skybox/blizzard2_ft.jpg');
let texture_bk = new THREE.TextureLoader().load('skybox/blizzard2_bk.jpg');
let texture_up = new THREE.TextureLoader().load('skybox/blizzard2_up.jpg');
let texture_dn = new THREE.TextureLoader().load('skybox/blizzard2_dn.jpg');
let texture_rt = new THREE.TextureLoader().load('skybox/blizzard2_rt.jpg');
let texture_lf = new THREE.TextureLoader().load('skybox/blizzard2_lf.jpg');
...
let p1 = loadModel('models/sci-fi-planet/sci-fi.gltf').then(result => {  model1 = result.scene.children[0]; });
let p2 = loadModel('models/letter-balloons/balloons.gltf').then(result => {  model2 = result.scene.children[0]; });
let p3 = loadModel('models/kinfolk-magazine/kinfolk.gltf').then(result => {  model3 = result.scene.children[0]; });
